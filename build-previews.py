...
WHAT IT DOES
  Reads posts.json and, for every post, creates two files in the ./p/ folder:
    assets/p/<id>.jpg   — a 1200x630 thumbnail (what WhatsApp/Telegram show)
    assets/p/<id>.html  — a tiny page with that post's preview tags that redirects
...
HOW TO USE
  ...
  3. Upload the updated posts.json AND the whole assets/p/ folder to your site.
...
OUT_DIR = os.path.join(HERE, "assets", "p")
...
def make_html(post):
    ...
    img = f"{BASE_URL}/assets/p/{pid}.jpg"
...
<meta property="og:url" content="{BASE_URL}/assets/p/{pid}.html">
...
def main():
    ...
    print("Next: upload posts.json and the whole assets/p/ folder to your site.")
